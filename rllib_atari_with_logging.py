...
logger.info("="*80)
logger.info("RLlib Atari Training with Checkpoint Logging")
logger.info("="*80)
...
logger.info(f"  minibatch_size: 128")
logger.info(f"  learning_rate: {0.00015 * NUM_LEARNERS}")
logger.info("-"*80)
...
logger.info("\n" + "="*80)
logger.info("Training completed, stopping algorithm")
logger.info("="*80)
algo.stop()
